...
import { FLAT_FEE, PRODUCT_CATEGORIES, SHIPPING_FEE } from '@/config'
                    ...
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            <p className="mt-2 text-base text-muted-foreground">
                                Your order was processed and you assets are
                            ...
                            <p className="mt-2 text-base text-muted-foreground">
                                ...
                                currently processing it. So hang tight and we
                                &apos;ll send you confirmation soon!
                            </p>
                        )}
                        <div className="mt-16 text-sm font-medium">
                            ...
                            <ul className="gorder gray-200 mt-6 divide-y divide-gray-200 border-t text-sm font-medium text-muted-foreground">
                            ...
                            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                                ...
                                <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                                    ...
                                    <p className="text-base">
                                        {formatPrice(
                                            orderTotal + SHIPPING_FEE + FLAT_FEE
                                        )}
                                    </p>
                                </div>
                            </div>
