      ...
      <MaxWidthWrapper>
        <div className="flex py-20 mx-auto text-center flex-col items-center max-w-3xl ">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to <span className="text-primary">BrandName</span>. Every
            product on our platform is verified by our team to ensure the
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <Button variant="ghost">Our quality pormise &rarr;</Button>
          </div>
        </div>
      </MaxWidthWrapper>
      {/* Products */}
              ...
              return (
                ...
                >
                  <div className="md:flex-shrink-0 flex justify-center">
                    <div className="w-16 h-16 flex items-center justify-center rounded-full bg-green-50  text-primary">
