...
exports.constructMetadata = exports.fiedlAccessOnlyAdmins = exports.colletionAccessOnlyAdmins = exports.formatPrice = exports.cn = void 0;
...
var colletionAccessOnlyAdmins = function (_a) {
    var user = _a.req.user;
    return user.role === 'admin';
};
exports.colletionAccessOnlyAdmins = colletionAccessOnlyAdmins;
var fiedlAccessOnlyAdmins = function (_a) {
    var user = _a.req.user;
    return user.role === 'admin';
};
exports.fiedlAccessOnlyAdmins = fiedlAccessOnlyAdmins;
