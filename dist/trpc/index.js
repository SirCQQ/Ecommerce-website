...
exports.appRouter = (0, trpc_1.router)({
    ...
    payment: payment_router_1.paymetRouter,
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        var query, cursor, limit, sort, queryOptions, payload, parsedQueryOpts, page, _c, items, hasNextPage, nextPage, hasPrevPage, prevPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _c = _d.sent(), items = _c.docs, hasNextPage = _c.hasNextPage, nextPage = _c.nextPage, hasPrevPage = _c.hasPrevPage, prevPage = _c.prevPage;
                    return [2 /*return*/, {
                            items: items,
