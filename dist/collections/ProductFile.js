...
var yourOwnOrPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, products, ownProductFileIds, orders, purchasedFileId;
    var req = _b.req;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                orders = (_c.sent()).docs;
                purchasedFileId = orders
                    .map(function (order) {
                    return order.products.map(function (product) {
                        if (typeof product === 'string') {
                            return req.payload.logger.error('Search depth insuficient to find purchased file IDs');
                        }
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], purchasedFileId, true), ownProductFileIds, true),
                        },
                    }];
        }
    });
