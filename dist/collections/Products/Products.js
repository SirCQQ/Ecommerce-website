    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                createdProductIds = allIds_1.filter(function (id, idx) { return allIds_1.indexOf(id) === idx; });
...
var createProductInStripe = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var createdProduct;
    var _a;
...
var updateProductInStripe = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedProduct;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, stripe_1.stripe.products.update(data.stripeId, {
                    name: data.name,
...
var createOrUpdateStripeProduct = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, createProductInStripe(data)];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                if (!(args.operation === 'update')) return [3 /*break*/, 4];
                return [4 /*yield*/, updateProductInStripe(data)];
...
exports.Products = {
    ...
    fields: [
        ...
        },
        {
            ...
            access: {
                create: utils_1.fiedlAccessOnlyAdmins,
                read: utils_1.fiedlAccessOnlyAdmins,
                update: utils_1.fiedlAccessOnlyAdmins,
            },
            options: [
